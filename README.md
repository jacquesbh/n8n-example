...
Simply set this environment variable to the list of community nodes (or other dependencies) you want to install (space-separated). For example:

```bash
clever env set APP_N8N_DEPENDENCIES "n8n-nodes-… n8n-nodes-… n8n-nodes-…"
```
